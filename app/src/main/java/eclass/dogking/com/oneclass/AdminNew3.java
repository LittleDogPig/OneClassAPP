...
public class AdminNew3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adminnew3);
        ...
        switch (view.getId()) {
            case R.id.udbutton:
                if (!((text1.length() < 1) || (text2.length() < 1) || (text3.length() < 1) || (text4.length() < 1) || (text5.length() < 1))) {
                    Toast.makeText(AdminNew3.this, "增加成功", Toast.LENGTH_SHORT).show();
                    finish();
                } else Toast.makeText(AdminNew3.this, "请填写完整信息", Toast.LENGTH_SHORT).show();
