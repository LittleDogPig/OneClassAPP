...
public class AdminSearch5 extends AppCompatActivity {
    ...
    private Manager5Adapter mrvAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search5);
    ...
    protected void initRV() {
        ...
        mrvAdapter = new Manager5Adapter(this, list, new RvListener() {
            @Override
    ...
    private void createdialog(final int position) {
        dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        deleteExam(list.get(position).getId());
                        dialog.dismiss();
                    }
                }).create();
    }
    ...
    private void getExamList(){
        Observable<HttpDefault<List<Exam>>> observable= OneclassUtils.createAPI(ExamAPI.class).getExam(
                name
        );
                ...
                .subscribe(new Observer<HttpDefault<List<Exam>>>() {
                    ...
                    public void onNext(@NonNull HttpDefault<List<Exam>> examShowHttpDefault) {
                        ...
                        if (examShowHttpDefault.getError_code() == -1) {
                            Toast.makeText(AdminSearch5.this,examShowHttpDefault.getMessage(), Toast.LENGTH_SHORT).show();
                        } else if (examShowHttpDefault.getError_code() == 0) {

                            list= examShowHttpDefault.getData();
                            initRV();
                ...
                .subscribe(new Observer<HttpDefault<String>>() {
                    ...
                    public void onNext(@NonNull HttpDefault<String> userHttpDefault) {
                        ...
                        if (userHttpDefault.getError_code() == -1) {
                            Toast.makeText(AdminSearch5.this, userHttpDefault.getMessage(), Toast.LENGTH_SHORT).show();
