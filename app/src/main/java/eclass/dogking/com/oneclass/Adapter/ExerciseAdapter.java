...
public class ExerciseAdapter extends RecyclerView.Adapter<ExerciseAdapter.ViewHolder> {
    ...
    public ExerciseAdapter(Context context, List<LectureShow> lectureShows, String tel) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int position) {
        ...
        Glide.with(mContext).load(OneclassUtils.getBaseURL() + lectureShow.getPictureUrl()).asBitmap().centerCrop().placeholder(R.mipmap.loading).error(R.mipmap.error).into(viewHolder.i1);
