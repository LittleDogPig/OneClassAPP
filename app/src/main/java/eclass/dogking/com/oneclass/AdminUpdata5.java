...
public class AdminUpdata5 extends AppCompatActivity {
    @BindView(R.id.edit1)
    EditText edit1;
    @BindView(R.id.edit2)
    EditText edit2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adminud5);
        ...
        switch (view.getId()) {
            case R.id.udbutton:
                if (!((text1.length() < 1) || (text2.length() < 1) || (text5.length() < 1))) {
                    Toast.makeText(AdminUpdata5.this, "修改成功", Toast.LENGTH_SHORT).show();
                    finish();
                } else Toast.makeText(AdminUpdata5.this, "请填写完整信息", Toast.LENGTH_SHORT).show();
