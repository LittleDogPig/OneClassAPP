...
import eclass.dogking.com.oneclass.ExamdetailActivity;
...
public class ExamAdapter extends RecyclerView.Adapter<ExamAdapter.ViewHolder> {
    ...
    public ExamAdapter(Context context,List<LectureShow> lectureShows,String tel) {
...
//.override(100, 100) .fitCenter()
        viewHolder.itemView.setOnClickListener(new View.OnClickListener(){
            public void  onClick(View v){
                ...
                Intent intent = new Intent(v.getContext(),ExamdetailActivity.class);
